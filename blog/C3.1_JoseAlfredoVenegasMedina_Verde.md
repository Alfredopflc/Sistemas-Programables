...
**R=** Se realizo un programa donde se declaro una salida para que de esta pudiera mandar la señal de encendido 1 segundo y luego una señal de apagado otro segundo en el Arduino UNO. En la simulacion se mostro que el LED se encendia y apagaba con un lapso de 1 segundo entre cada estado.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.  
**EVIDENCIAS:**  
![Captura 1](../img/C3.1_Captura1.png)  
![Captura 2](../img/C3.1_Captura2.png)

...
**R=** Se realizo un programa que detectaria el valor analogico del fotoresistor y lo convirtiera en un valor de voltaje. Ya que el voltaje va de 0 a 5 y el valor de la señal va de 0 a 1023, se realiza una division de 5 entre 1023 y se multiplica por la señal del sensor. Asi, en el monitor en serie de imprime el resultado obtenido.

![Captura 1](../img/C3.3_Captura1.png)  
![Captura 2](../img/C3.3_Captura2.png)
